  ...
  return (
    ...
    <div className="page-container">
      ...
      <Column lg={16} md={8} sm={4} className="landing-page__r2" style={{ marginBottom: '1rem' }}>
        <Tile lg={4} md={4} sm={4}>
          <Grid>
            <Column lg={2} md={8} sm={4}>Total Applications <br />   {isLoading && <SkeletonText />} {!isLoading &&  <h3>  {groups.length}</h3>} </Column>
            <Column lg={2} md={8} sm={4}>NaN <br />  {isLoading && <SkeletonText />} {!isLoading &&  <h3>  {groups.length-1} </h3>}   </Column>
            <Column lg={6} md={8} sm={4}>NaN<br />  {isLoading && <SkeletonText />} {!isLoading &&  <h3> 1</h3>}   </Column>
          </Grid>
        </Tile>
      </Column>
